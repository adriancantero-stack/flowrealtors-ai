...
Return:
{
  ...
  "bedrooms": "Number (e.g. 2, 3+) or Unknown",
  "bathrooms": "Number (e.g. 1, 2) or Unknown",
  "condition": "New | Resale | Fixer-upper | Unknown",
  "location_priority": "e.g. Near schools | Quiet | Central | Unknown",
